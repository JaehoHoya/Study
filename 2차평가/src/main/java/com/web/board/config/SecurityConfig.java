...
public class SecurityConfig
{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authz -> authz
                        .requestMatchers("/board/main","/board/main/**", "/board/detail/*", "/board/loginForm", "/board/logout" ,"/board/search","/board/search/**").permitAll()
                        .requestMatchers("/file/*","/board/addForm","board/add","board/delete/*").hasAnyRole("USER", "ADMIN")
                        .requestMatchers("/board/updateForm/*","/board/update").hasAnyRole("USER")
