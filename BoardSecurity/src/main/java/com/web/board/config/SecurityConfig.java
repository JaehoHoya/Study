...
public class SecurityConfig
{
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authz -> authz
                        .requestMatchers("/board/main", "/board/detail/*", "/board/loginForm", "/board/logout").permitAll()
                        .requestMatchers("/board/addForm","board/add","/board/updateForm/*","board/update","board/delete/*").hasAnyRole("USER", "ADMIN")
