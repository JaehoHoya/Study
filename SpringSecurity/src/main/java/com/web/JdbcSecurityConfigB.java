...
@Configuration
@EnableWebSecurity
public class JdbcSecurityConfigB
{
    @Autowired
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(authz -> authz
                        .requestMatchers("/","/board/hello", "/board", "/board/loginForm", "/board/denied", "/logout").permitAll()
                        ...
                        .requestMatchers("/board/menu").hasAnyRole("USER", "ADMIN", "MASTER")
                ...
                .defaultSuccessUrl("/board/menu", true)
