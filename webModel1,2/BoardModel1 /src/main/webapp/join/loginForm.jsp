		...
		function login()
		{
			...
			$.ajax({ // 어떤 서버에 어떤 데이터를 전송하고 응답은 어떤 변수에 받겠다 
				...
				success:function(res)
				{
					...
					if(res.ok) location.href="../board/index.jsp";
				},
...
<div id ="main">
	 <h3>로그인</h3>
	 <form  id="Form" action="userLogin.jsp" method="post">  <!-- 이용자 눈에 안보인다? -->
	 		...
	 		<div>
	 			...
	 			<button type="button" onClick="login();">로그인</button>  <!--post 방식으로 전송  -->
	 		</div>
